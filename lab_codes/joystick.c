...
// uint16_t x, y;
// const uint8_t figures[20] = {0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x67,   // 0 -
// 9
//                              0x77, 0x7C, 0x39, 0x5E, 0x79, 0x71, 0x3D, 0x76, 0x30, 0x1E};  // A -
//                              J
// uint8_t digit;
...
//     // no need to touch the MUX bits for now - they'll be updated below as we choose which axis
//     to
//     // read from
//     ADMUX = (1 << REFS0);
...
//     // if `digit` is 1, output the value of `y`, scaled and encoded, to the left display of the
//     SSD
